...
describe('Orders Controller', () => {
	...
	describe('createOrder', () => {
		it('should create order successfully', async () => {
			...
			vi.spyOn(ordersService, 'createOrderFromCart').mockResolvedValue(mockOrder);
			vi.spyOn(ordersController, 'createOrder').mockImplementation(async (req, res) => {
				const order = await ordersService.createOrderFromCart(req.user.id, { shippingAddressIndex: req.body.shippingAddressIndex });
